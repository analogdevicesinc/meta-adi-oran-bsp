...
#define ADI_KERBEROS_ETILE_HACK_MASK			0x3
#define ADI_KERBEROS_RSFEC_BIT				BIT(1)
#define ADI_KERBEROS_XCVR_BIT				BIT(0)
#define ADI_KERBEROS_RSFEC_OFFSET			0x40000
#define ADI_KERBEROS_XCVR_OFFSET			0x400000
#endif
...
#ifdef CONFIG_INTEL_FPGA_ETILE_LITE
struct intel_fpga_etile_lite_ethernet {
	struct net_device *dev;
	void (*link_down)(struct net_device *dev);
	void (*link_up)(struct net_device *dev);
};
#endif
...
#ifdef CONFIG_INTEL_FPGA_ETILE_LITE
	/* If E-Tile is used in lite mode, it connects to another net device */
	const struct intel_fpga_etile_lite_ethernet *ethernet;
#endif
	/* Phylink */
...
#ifdef CONFIG_INTEL_FPGA_ETILE_LITE
void intel_fpga_etile_set_ethernet(struct net_device *dev,
				   const struct intel_fpga_etile_lite_ethernet *ethernet);
#endif
